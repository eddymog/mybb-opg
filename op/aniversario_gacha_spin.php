...
if ($banner === 'berries' && (int)$ficha['berries'] < $costo_total) {
    echo json_encode(['error' => 'No tienes suficientes berries.']); exit;
}
if ($banner === 'kuros' && (int)$ficha['kuro'] < $costo_total) {
...
$log_esc     = $db->escape_string("Gacha Aniversario [$banner x$cantidad]: $log_nombres");
